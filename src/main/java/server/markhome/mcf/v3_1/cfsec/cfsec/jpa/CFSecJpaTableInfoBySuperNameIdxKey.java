// Description: Java 25 JPA implementation of a TableInfo by SuperNameIdx index key object.
	...
	implements ICFSecTableInfoBySuperNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecTableInfoBySuperNameIdxKey, ICFSecTableInfo$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecTableInfoBySuperNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a ISOCtry history primary key object.
...
/**
 *	CFSecJpaISOCtryHPKey History Primary Key for ISOCtry
 *		requiredISOCtryId	Required object attribute ISOCtryId.
 */
public class CFSecJpaISOCtryHPKey
	implements ICFSecISOCtryHPKey, Comparable<Object>, Serializable
{
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecISOCtryHPKey rhs) {
		...
		else if (obj instanceof ICFSecISOCtry rhs) {
			if( getRequiredISOCtryId() != rhs.getRequiredISOCtryId() ) {
				return( false );
			}
			return( true );
	...
	public int compareTo( Object obj ) {
		...
		if (obj == this) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecISOCtryPKey, ICFSecISOCtry, CFSecISOCtryHPKey, CFSecISOCtryH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaISOCtryHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

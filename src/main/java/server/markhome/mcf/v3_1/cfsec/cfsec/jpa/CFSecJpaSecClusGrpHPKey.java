// Description: Java 25 JPA implementation of a SecClusGrp history primary key object.
...
/**
 *	CFSecJpaSecClusGrpHPKey History Primary Key for SecClusGrp
 *		requiredSecClusGrpId	Required object attribute SecClusGrpId.
 */
public class CFSecJpaSecClusGrpHPKey
	implements ICFSecSecClusGrpHPKey, Comparable<Object>, Serializable
{
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecSecClusGrpHPKey rhs) {
		...
		else if (obj instanceof ICFSecSecClusGrp rhs) {
			if( getRequiredSecClusGrpId() != null ) {
				if( rhs.getRequiredSecClusGrpId() != null ) {
					if( ! getRequiredSecClusGrpId().equals( rhs.getRequiredSecClusGrpId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		if (obj == this) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusGrpPKey, ICFSecSecClusGrp, CFSecSecClusGrpHPKey, CFSecSecClusGrpH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecClusGrpHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

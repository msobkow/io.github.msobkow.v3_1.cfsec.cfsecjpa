// Description: Java 25 JPA implementation of a Cluster entity definition object.
...
@Entity
@Table(
	name = "clus", schema = "CFSec31",
	indexes = {
		@Index(name = "ClusterIdIdx", columnList = "Id", unique = true),
		@Index(name = "ClusterUDomNameIdx", columnList = "FullDomName", unique = true),
		@Index(name = "ClusterUDescrNameIdx", columnList = "Description", unique = true)
	}
)
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFSecPU")
public class CFSecJpaCluster
		...
		Serializable
{
	...
	protected CFLibDbKeyHash256 createdByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$Cluster.S_INIT_CREATED_BY);
	...
	protected CFLibDbKeyHash256 updatedByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$Cluster.S_INIT_UPDATED_BY);
	...
	public String toString() {
		String ret = "<CFSecJpaCluster" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

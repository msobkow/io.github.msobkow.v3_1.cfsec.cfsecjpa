// Description: Java 25 JPA implementation of a ISOCcy entity definition object.
...
@Entity
@Table(
	name = "iso_ccy", schema = "CFSec31",
	indexes = {
		@Index(name = "ISOCcyIdIdx", columnList = "ISOCcyId", unique = true),
		@Index(name = "ISOCcyCodeIdx", columnList = "iso_code", unique = true),
		@Index(name = "ISOCcyNameIdx", columnList = "ccy_name", unique = true)
	}
)
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFSecPU")
public class CFSecJpaISOCcy
		...
		Serializable
{
	...
	protected CFLibDbKeyHash256 createdByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$ISOCcy.S_INIT_CREATED_BY);
	...
	protected CFLibDbKeyHash256 updatedByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$ISOCcy.S_INIT_UPDATED_BY);
	...
	public String toString() {
		String ret = "<CFSecJpaISOCcy" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

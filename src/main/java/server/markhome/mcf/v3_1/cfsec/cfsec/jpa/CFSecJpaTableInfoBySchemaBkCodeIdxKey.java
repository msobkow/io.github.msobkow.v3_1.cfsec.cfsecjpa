// Description: Java 25 JPA implementation of a TableInfo by SchemaBkCodeIdx index key object.
	...
	implements ICFSecTableInfoBySchemaBkCodeIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecTableInfoBySchemaBkCodeIdxKey, ICFSecTableInfo$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecTableInfoBySchemaBkCodeIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

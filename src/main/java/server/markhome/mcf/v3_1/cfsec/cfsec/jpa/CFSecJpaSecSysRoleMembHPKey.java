// Description: Java 25 JPA implementation of a SecSysRoleMemb history primary key object.
...
/**
 *	CFSecJpaSecSysRoleMembHPKey History Primary Key for SecSysRoleMemb
 *		requiredSecSysRoleId	Required object attribute SecSysRoleId.
 *		requiredLoginId	Required object attribute LoginId.
 */
public class CFSecJpaSecSysRoleMembHPKey
	implements ICFSecSecSysRoleMembHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public CFSecJpaSecSysRoleMembHPKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == this) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecSysRoleMembPKey, ICFSecSecSysRoleMemb, CFSecSecSysRoleMembHPKey, CFSecSecSysRoleMembH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecSysRoleMembHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

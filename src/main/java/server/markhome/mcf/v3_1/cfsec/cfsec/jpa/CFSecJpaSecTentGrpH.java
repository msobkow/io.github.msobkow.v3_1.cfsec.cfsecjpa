// Description: Java 25 JPA implementation of SecTentGrp history objects
...
/**
 *  CFSecJpaSecTentGrpH provides history objects matching the CFSecSecTentGrp change history.
...
@Entity
@Table(
    name = "SecTentGrp_h", schema = "CFSec31",
    indexes = {
        @Index(name = "SecTentGrpIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, SecTentGrpId", unique = true),
        @Index(name = "SecTentGrpTenantIdx_h", columnList = "TenantId", unique = false),
        @Index(name = "SecTentGrpNameIdx_h", columnList = "safe_name", unique = false),
        @Index(name = "SecTentGrpUNameIdx_h", columnList = "TenantId, safe_name", unique = false)
    }
)
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFSecPU")
public class CFSecJpaSecTentGrpH
    implements ICFSecSecTentGrpH, Comparable<Object>, Serializable
{
	...
	protected CFLibDbKeyHash256 createdByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$SecTentGrp.S_INIT_CREATED_BY);
	...
	protected CFLibDbKeyHash256 updatedByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$SecTentGrp.S_INIT_UPDATED_BY);
    ...
    @Override
    public ICFSecSecTentGrpHPKey getPKey() {
        return( pkey );
    }

    @Override
    public void setPKey( ICFSecSecTentGrpHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecJpaSecTentGrpHPKey) {
    ...
    public boolean equals( Object obj ) {
        ...
        else if (obj instanceof ICFSecSecTentGrp) {
            ICFSecSecTentGrp rhs = (ICFSecSecTentGrp)obj;
		if (getPKey() != null) {
			if (rhs.getPKey() != null) {
        ...
        else if (obj instanceof ICFSecSecTentGrpHPKey) {
		ICFSecSecTentGrpHPKey rhs = (ICFSecSecTentGrpHPKey)obj;
    ...
    public String toString() {
        String ret = "<CFSecJpaSecTentGrpH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}

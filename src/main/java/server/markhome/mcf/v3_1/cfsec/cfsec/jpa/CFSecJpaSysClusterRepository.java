...
public interface CFSecJpaSysClusterRepository extends JpaRepository<CFSecJpaSysCluster, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFSecJpaSysCluster save(CFSecJpaSysCluster obj);

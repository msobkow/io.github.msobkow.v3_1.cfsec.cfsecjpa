...
public interface CFSecJpaSecSysGrpIncRepository extends JpaRepository<CFSecJpaSecSysGrpInc, CFSecJpaSecSysGrpIncPKey> {
	...
	@Transactional
	@Modifying
	CFSecJpaSecSysGrpInc save(CFSecJpaSecSysGrpInc obj);
	...
	CFSecJpaSecSysGrpInc get(@Param("secSysGrpId") $implJavaAtomType$ requiredSecSysGrpId,
		@Param("inclName") $implJavaAtomType$ requiredInclName);
	...
	default CFSecJpaSecSysGrpInc get(ICFSecSecSysGrpIncPKey key) {
		return( get(key.getRequiredSecSysGrpId(), key.getRequiredInclName()));
	}
	...
	List<CFSecJpaSecSysGrpInc> findBySysGrpIdx(@Param("secSysGrpId") $implJavaAtomType$ requiredSecSysGrpId);
	 ...
	 *		@return List&lt;CFSecJpaSecSysGrpInc&gt; of the found entities, typically from the JPA cache, or an empty list if no such entities exist.
	 */
	@Query("select r from CFSecJpaSecSysGrpInc r where r.requiredParentSubGroup.requiredName = :inclName")
	List<CFSecJpaSecSysGrpInc> findByNameIdx(@Param("inclName") $implJavaAtomType$ requiredInclName);
	...
	@Query("select r from CFSecJpaSecSysGrpInc r where r.requiredContainerGroup.requiredSecSysGrpId = :secSysGrpId and r.requiredParentSubGroup.requiredName = :inclName")
	CFSecJpaSecSysGrpInc lockByIdIdx(@Param("secSysGrpId") $implJavaAtomType$ requiredSecSysGrpId,
		@Param("inclName") $implJavaAtomType$ requiredInclName);
	...
	default CFSecJpaSecSysGrpInc lockByIdIdx(ICFSecSecSysGrpIncPKey key) {
		return( lockByIdIdx(key.getRequiredSecSysGrpId(), key.getRequiredInclName()));
	}
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFSecJpaSecSysGrpInc r where r.requiredContainerGroup.requiredSecSysGrpId = :secSysGrpId")
	List<CFSecJpaSecSysGrpInc> lockBySysGrpIdx(@Param("secSysGrpId") $implJavaAtomType$ requiredSecSysGrpId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFSecJpaSecSysGrpInc r where r.requiredParentSubGroup.requiredName = :inclName")
	List<CFSecJpaSecSysGrpInc> lockByNameIdx(@Param("inclName") $implJavaAtomType$ requiredInclName);
	...
	void deleteByIdIdx(@Param("secSysGrpId") $implJavaAtomType$ requiredSecSysGrpId,
		@Param("inclName") $implJavaAtomType$ requiredInclName);
	...
	default void deleteByIdIdx(ICFSecSecSysGrpIncPKey key) {
		deleteByIdIdx(key.getRequiredSecSysGrpId(), key.getRequiredInclName());
	}
	...
	void deleteBySysGrpIdx(@Param("secSysGrpId") $implJavaAtomType$ requiredSecSysGrpId);
	...
	@Transactional
	@Modifying
	@Query("delete from CFSecJpaSecSysGrpInc r where r.requiredParentSubGroup.requiredName = :inclName")
	void deleteByNameIdx(@Param("inclName") $implJavaAtomType$ requiredInclName);

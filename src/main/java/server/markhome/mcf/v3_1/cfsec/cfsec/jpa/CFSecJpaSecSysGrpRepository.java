...
public interface CFSecJpaSecSysGrpRepository extends JpaRepository<CFSecJpaSecSysGrp, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFSecJpaSecSysGrp save(CFSecJpaSecSysGrp obj);

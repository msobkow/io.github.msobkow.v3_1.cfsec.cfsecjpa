...
public interface CFSecJpaSecTentGrpRepository extends JpaRepository<CFSecJpaSecTentGrp, CFLibDbKeyHash256> {
	 ...
	 */
	@Query("select r from CFSecJpaSecTentGrp r where r.requiredContainerTenant.requiredId = :tenantId")
	 ...
	 *		@return List&lt;CFSecJpaSecTentGrp&gt; of the found entities, typically from the JPA cache, or an empty list if no such entities exist.
	 */
	@Query("select r from CFSecJpaSecTentGrp r where r.requiredParentSysGrp.requiredName = :name")
	 ...
	 */
	@Query("select r from CFSecJpaSecTentGrp r where r.requiredContainerTenant.requiredId = :tenantId and r.requiredParentSysGrp.requiredName = :name")
	...
	@Transactional
	@Modifying
	@Query("delete from CFSecJpaSecTentGrp r where r.requiredContainerTenant.requiredId = :tenantId")
	...
	@Transactional
	@Modifying
	@Query("delete from CFSecJpaSecTentGrp r where r.requiredParentSysGrp.requiredName = :name")
	...
	@Transactional
	@Modifying
	@Query("delete from CFSecJpaSecTentGrp r where r.requiredContainerTenant.requiredId = :tenantId and r.requiredParentSysGrp.requiredName = :name")

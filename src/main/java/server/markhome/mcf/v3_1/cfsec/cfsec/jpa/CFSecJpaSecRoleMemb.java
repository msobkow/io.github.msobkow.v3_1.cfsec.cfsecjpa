// Description: Java 25 JPA implementation of a SecRoleMemb entity definition object.
...
@Entity
@Table(
	name = "SecRoleMemb", schema = "CFSec31",
	indexes = {
		@Index(name = "SecRoleMembIdIdx", columnList = "SecRoleId, login_id", unique = true),
		@Index(name = "SecRoleMembRoleIdx", columnList = "SecRoleId", unique = false),
		@Index(name = "SecRoleMembLoginIdx", columnList = "login_id", unique = false)
	}
)
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFSecPU")
public class CFSecJpaSecRoleMemb
		...
		Serializable
{
	...
	@EmbeddedId
	CFSecJpaSecRoleMembPKey pkey = new CFSecJpaSecRoleMembPKey();
	...
	public CFSecJpaSecRoleMemb() {
		pkey = new CFSecJpaSecRoleMembPKey();
	}
	...
	@Override
	public void setPKey(ICFSecSecRoleMembPKey pkey ) {
		if (pkey == null) {
			throw new CFLibNullArgumentException(getClass(), "setPKey", 1, "pkey");
		}
		else if (!(pkey instanceof CFSecJpaSecRoleMembPKey)) {
			throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecJpaSecRoleMembPKey");
		}
		this.pkey = (CFSecJpaSecRoleMembPKey)pkey;
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecRoleMemb" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

...
public interface CFSecJpaSecSysRoleEnablesRepository extends JpaRepository<CFSecJpaSecSysRoleEnables, CFSecJpaSecSysRoleEnablesPKey> {
	...
	CFSecJpaSecSysRoleEnables get(@Param("secSysRoleId") $implJavaAtomType$ requiredSecSysRoleId,
	...
	List<CFSecJpaSecSysRoleEnables> findBySysRoleIdx(@Param("secSysRoleId") $implJavaAtomType$ requiredSecSysRoleId);
	...
	List<CFSecJpaSecSysRoleEnables> findByNameIdx(@Param("enableName") $implJavaAtomType$ requiredEnableName);
	...
	@Query("select r from CFSecJpaSecSysRoleEnables r where r.requiredContainerSysRole.requiredSecSysRoleId = :secSysRoleId and r.requiredParentEnableGroup.requiredName = :enableName")
	CFSecJpaSecSysRoleEnables lockByIdIdx(@Param("secSysRoleId") $implJavaAtomType$ requiredSecSysRoleId,
		@Param("enableName") $implJavaAtomType$ requiredEnableName);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFSecJpaSecSysRoleEnables r where r.requiredContainerSysRole.requiredSecSysRoleId = :secSysRoleId")
	List<CFSecJpaSecSysRoleEnables> lockBySysRoleIdx(@Param("secSysRoleId") $implJavaAtomType$ requiredSecSysRoleId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFSecJpaSecSysRoleEnables r where r.requiredParentEnableGroup.requiredName = :enableName")
	List<CFSecJpaSecSysRoleEnables> lockByNameIdx(@Param("enableName") $implJavaAtomType$ requiredEnableName);
	...
	void deleteByIdIdx(@Param("secSysRoleId") $implJavaAtomType$ requiredSecSysRoleId,
		@Param("enableName") $implJavaAtomType$ requiredEnableName);
	...
	void deleteBySysRoleIdx(@Param("secSysRoleId") $implJavaAtomType$ requiredSecSysRoleId);
	...
	void deleteByNameIdx(@Param("enableName") $implJavaAtomType$ requiredEnableName);

// Description: Java 25 JPA implementation of a SecRoleMemb by RoleIdx index key object.
	...
	implements ICFSecSecRoleMembByRoleIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecRoleMembByRoleIdxKey, ICFSecSecRoleMemb, ICFSecSecRoleMembH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecRoleMembByRoleIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a SecTentRole by UNameIdx index key object.
...
public class CFSecJpaSecTentRoleByUNameIdxKey
	implements ICFSecSecTentRoleByUNameIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTenantId;
	protected String requiredName;
	public CFSecJpaSecTentRoleByUNameIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecTentRoleByUNameIdxKey, ICFSecSecTentRole$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecTentRoleByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

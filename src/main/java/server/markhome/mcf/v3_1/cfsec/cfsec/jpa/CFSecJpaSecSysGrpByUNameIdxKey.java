// Description: Java 25 JPA implementation of a SecSysGrp by UNameIdx index key object.
	...
	implements ICFSecSecSysGrpByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecSysGrpByUNameIdxKey, ICFSecSecSysGrp$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecSysGrpByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

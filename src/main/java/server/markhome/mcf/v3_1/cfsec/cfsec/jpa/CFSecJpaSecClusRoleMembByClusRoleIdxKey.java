// Description: Java 25 JPA implementation of a SecClusRoleMemb by ClusRoleIdx index key object.
...
{
	protected $iterate Columns ( lone implIJavaAtomType first implIJavaAtomType each implCommaIJavaAtomType empty empty )$ requiredSecClusRoleId;
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusRoleMembByClusRoleIdxKey, ICFSecSecClusRoleMemb, ICFSecSecClusRoleMembH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecClusRoleMembByClusRoleIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

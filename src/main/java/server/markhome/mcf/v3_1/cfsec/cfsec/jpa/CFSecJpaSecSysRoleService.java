...
public class CFSecJpaSecSysRoleService {
	...
	public CFSecJpaSecSysRole create(CFSecJpaSecSysRole data) {
		...
		CFLibDbKeyHash256 originalRequiredSecSysRoleId = data.getRequiredSecSysRoleId();
	...
	public CFSecJpaSecSysRole update(CFSecJpaSecSysRole data) {
		...
		CFSecJpaSecSysRole existing = cfsec31SecSysRoleRepository.findById((CFLibDbKeyHash256)(data.getPKey()))
	...
	public CFSecJpaSecSysRole find(@Param("secSysRoleId") CFLibDbKeyHash256 requiredSecSysRoleId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfsec31TransactionManager")
	public CFSecJpaSecSysRole lockByIdIdx(@Param("secSysRoleId") CFLibDbKeyHash256 requiredSecSysRoleId) {

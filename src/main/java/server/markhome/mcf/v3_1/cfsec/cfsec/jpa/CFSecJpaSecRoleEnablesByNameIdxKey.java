// Description: Java 25 JPA implementation of a SecRoleEnables by NameIdx index key object.
	...
	implements ICFSecSecRoleEnablesByNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecRoleEnablesByNameIdxKey, ICFSecSecRoleEnables, ICFSecSecRoleEnablesH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecRoleEnablesByNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

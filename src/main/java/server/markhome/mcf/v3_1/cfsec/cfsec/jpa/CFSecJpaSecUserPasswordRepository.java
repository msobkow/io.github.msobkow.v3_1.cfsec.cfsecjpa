...
public interface CFSecJpaSecUserPasswordRepository extends JpaRepository<CFSecJpaSecUserPassword, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFSecJpaSecUserPassword save(CFSecJpaSecUserPassword obj);

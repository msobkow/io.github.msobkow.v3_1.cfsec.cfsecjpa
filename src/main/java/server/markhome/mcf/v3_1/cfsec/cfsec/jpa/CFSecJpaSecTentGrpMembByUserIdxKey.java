// Description: Java 25 JPA implementation of a SecTentGrpMemb by UserIdx index key object.
...
public class CFSecJpaSecTentGrpMembByUserIdxKey
	implements ICFSecSecTentGrpMembByUserIdxKey, Comparable<Object>, Serializable
{
	protected String requiredLoginId;
	public CFSecJpaSecTentGrpMembByUserIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecTentGrpMembByUserIdxKey, ICFSecSecTentGrpMemb$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecTentGrpMembByUserIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a SecUser history primary key object.
...
/**
 *	CFSecJpaSecUserHPKey History Primary Key for SecUser
 *		requiredSecUserId	Required object attribute SecUserId.
 */
public class CFSecJpaSecUserHPKey
	implements ICFSecSecUserHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecSecUserPKey rhs) {
			if( getRequiredSecUserId() != null ) {
				if( rhs.getRequiredSecUserId() != null ) {
					if( ! getRequiredSecUserId().equals( rhs.getRequiredSecUserId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecProtSecUserPKey rhs) {
			if( getRequiredSecUserId() != null ) {
				if( rhs.getRequiredSecUserId() != null ) {
					if( ! getRequiredSecUserId().equals( rhs.getRequiredSecUserId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecPubSecUserPKey rhs) {
			if( getRequiredSecUserId() != null ) {
				if( rhs.getRequiredSecUserId() != null ) {
					if( ! getRequiredSecUserId().equals( rhs.getRequiredSecUserId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFSecJpaSecUserHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

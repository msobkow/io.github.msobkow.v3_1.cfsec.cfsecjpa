// Description: Java JPA implementation of a SecTentRoleMemb primary key object.
	...
	implements ICFSecSecTentRoleMembPKey, Comparable<ICFSecSecTentRoleMembPKey>, Serializable
{
	...
	public void setRequiredContainerRole(CFLibDbKeyHash256 argSecTentRoleId) {
		...
		ICFSecSecTentRole targetRec = targetTable.readDerivedByIdIdx(null, argSecTentRoleId);
	...
	public CFLibDbKeyHash256 getRequiredSecTentRoleId() {
		ICFSecSecTentRole result = getRequiredContainerRole();
		if (result != null) {
			return result.getRequiredSecTentRoleId();
		}
		else {
			throw new CFLibNullArgumentException(getClass(), "getRequiredSecTentRoleId", 0, "getRequiredContainerRole()");
		}
	}
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecSecTentRoleMembPKey) {
			ICFSecSecTentRoleMembPKey rhs = (ICFSecSecTentRoleMembPKey)obj;
	...
	public String toString() {
		String ret = "<CFSecSecTentRoleMembPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a SecSysGrpMemb history primary key object.
...
/**
 *	CFSecJpaSecSysGrpMembHPKey History Primary Key for SecSysGrpMemb
 *		requiredSecSysGrpId	Required object attribute SecSysGrpId.
 *		requiredLoginId	Required object attribute LoginId.
 */
public class CFSecJpaSecSysGrpMembHPKey
	implements ICFSecSecSysGrpMembHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public CFSecJpaSecSysGrpMembHPKey() {
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecSecSysGrpMembPKey rhs) {
			if( getRequiredSecSysGrpId() != null ) {
				if( rhs.getRequiredSecSysGrpId() != null ) {
					if( ! getRequiredSecSysGrpId().equals( rhs.getRequiredSecSysGrpId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecSecSysGrpMembH rhs) {
			if (getAuditClusterId() != null) {
				if (rhs.getAuditClusterId() != null) {
					if ( ! getAuditClusterId().equals(rhs.getAuditClusterId())) {
						return( false );
		...
		else if (obj instanceof ICFSecSecSysGrpMemb rhs) {
			if( getRequiredSecSysGrpId() != null ) {
				if( rhs.getRequiredSecSysGrpId() != null ) {
					if( ! getRequiredSecSysGrpId().equals( rhs.getRequiredSecSysGrpId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecProtSecSysGrpMembPKey rhs) {
			if( getRequiredSecSysGrpId() != null ) {
				if( rhs.getRequiredSecSysGrpId() != null ) {
					if( ! getRequiredSecSysGrpId().equals( rhs.getRequiredSecSysGrpId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		if (obj == this) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecSysGrpMembPKey, ICFSecSecSysGrpMemb, CFSecSecSysGrpMembHPKey, CFSecSecSysGrpMembH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecSysGrpMembHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

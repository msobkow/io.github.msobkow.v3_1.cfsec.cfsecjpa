// Description: Java 25 JPA implementation of a SecSysRoleMemb by SysRoleIdx index key object.
...
public class CFSecJpaSecSysRoleMembBySysRoleIdxKey
	implements ICFSecSecSysRoleMembBySysRoleIdxKey, Comparable<Object>, Serializable
{
	...
	public CFSecJpaSecSysRoleMembBySysRoleIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecSysRoleMembBySysRoleIdxKey, ICFSecSecSysRoleMemb$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecSysRoleMembBySysRoleIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

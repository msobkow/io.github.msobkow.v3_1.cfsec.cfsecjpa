...
public interface CFSecJpaSecSysRoleRepository extends JpaRepository<CFSecJpaSecSysRole, CFLibDbKeyHash256> {
	...
	CFSecJpaSecSysRole get(@Param("secSysRoleId") CFLibDbKeyHash256 requiredSecSysRoleId);
	...
	@Query("select r from CFSecJpaSecSysRole r where r.requiredSecSysRoleId = :secSysRoleId")
	CFSecJpaSecSysRole lockByIdIdx(@Param("secSysRoleId") CFLibDbKeyHash256 requiredSecSysRoleId);

// Description: Java 25 JPA implementation of a SecTentRoleMemb by TentRoleIdx index key object.
...
$refernce Column implProtReqSetter$
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecTentRoleMembByTentRoleIdxKey, ICFSecSecTentRoleMemb$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecTentRoleMembByTentRoleIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of SecClusGrp history objects
...
/**
 *  CFSecJpaSecClusGrpH provides history objects matching the CFSecSecClusGrp change history.
...
@Entity
@Table(
    name = "SecClusGrp_h", schema = "CFSec31",
    indexes = {
        @Index(name = "SecClusGrpIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, SecClusGrpId", unique = true),
        @Index(name = "SecClusGrpClusterIdx_h", columnList = "ClusterId", unique = false),
        @Index(name = "SecClusGrpNameIdx_h", columnList = "safe_name", unique = false),
    ...
    implements ICFSecSecClusGrpH, Comparable<Object>, Serializable
{
    ...
    @EmbeddedId
    protected CFSecJpaSecClusGrpHPKey pkey;
	@AttributeOverrides({
		@AttributeOverride( name="bytes", column = @Column( name="CreatedByUserId", nullable=false, length=CFLibDbKeyHash256.HASH_LENGTH ) )
	})
	protected CFLibDbKeyHash256 createdByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$SecClusGrp.S_INIT_CREATED_BY);
	...
	protected CFLibDbKeyHash256 updatedByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$SecClusGrp.S_INIT_UPDATED_BY);
    ...
    public CFSecJpaSecClusGrpH() {
            ...
            pkey = new CFSecJpaSecClusGrpHPKey();
    ...
    public void setPKey( ICFSecSecClusGrpHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecJpaSecClusGrpHPKey) {
                this.pkey = (CFSecJpaSecClusGrpHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecJpaSecClusGrpHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecJpaSecClusGrpH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}

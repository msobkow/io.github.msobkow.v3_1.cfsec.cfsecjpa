// Description: Java 25 JPA implementation of a Tenant by ClusterIdx index key object.
	...
	implements ICFSecTenantByClusterIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecTenantByClusterIdxKey, ICFSecTenant$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecTenantByClusterIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

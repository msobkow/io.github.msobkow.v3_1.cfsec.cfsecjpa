// Description: Java 25 JPA implementation of a SecSysGrpMemb entity definition object.
...
@Entity
@Table(
	name = "SecSysGrpMemb", schema = "CFSec31",
	indexes = {
...
public class CFSecJpaSecSysGrpMemb
		...
		Serializable
{
	...
	public CFSecJpaSecSysGrpMemb() {
		pkey = new CFSecJpaSecSysGrpMembPKey();
	}
	...
	public void setPKey(ICFSecSecSysGrpMembPKey pkey ) {
		...
		else if (!(pkey instanceof CFSecJpaSecSysGrpMembPKey)) {
			throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecJpaSecSysGrpMembPKey");
		}
		this.pkey = (CFSecJpaSecSysGrpMembPKey)pkey;
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecSysGrpMemb" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

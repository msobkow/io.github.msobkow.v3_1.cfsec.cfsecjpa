// Description: Java 25 JPA implementation of a ISOCtryCcy history primary key object.
	...
	implements ICFSecISOCtryCcyHPKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == this) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecISOCtryCcyPKey, ICFSecISOCtryCcy, CFSecISOCtryCcyHPKey, CFSecISOCtryCcyH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaISOCtryCcyHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

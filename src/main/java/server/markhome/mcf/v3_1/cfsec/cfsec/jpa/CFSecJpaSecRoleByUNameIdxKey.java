// Description: Java 25 JPA implementation of a SecRole by UNameIdx index key object.
...
public class CFSecJpaSecRoleByUNameIdxKey
	implements ICFSecSecRoleByUNameIdxKey, Comparable<Object>, Serializable
{
	protected String requiredName;
	public CFSecJpaSecRoleByUNameIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecRoleByUNameIdxKey, ICFSecSecRole, ICFSecSecRoleH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecRoleByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

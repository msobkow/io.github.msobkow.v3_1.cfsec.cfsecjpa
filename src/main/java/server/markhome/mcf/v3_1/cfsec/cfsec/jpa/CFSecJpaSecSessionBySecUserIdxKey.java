// Description: Java 25 JPA implementation of a SecSession by SecUserIdx index key object.
	...
	implements ICFSecSecSessionBySecUserIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecSessionBySecUserIdxKey, ICFSecSecSession$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecSessionBySecUserIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

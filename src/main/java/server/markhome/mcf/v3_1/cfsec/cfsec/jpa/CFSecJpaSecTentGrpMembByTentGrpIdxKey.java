// Description: Java 25 JPA implementation of a SecTentGrpMemb by TentGrpIdx index key object.
	...
	implements ICFSecSecTentGrpMembByTentGrpIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecTentGrpMembByTentGrpIdxKey, ICFSecSecTentGrpMemb$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecTentGrpMembByTentGrpIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

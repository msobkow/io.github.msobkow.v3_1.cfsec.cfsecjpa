// Description: Java 25 JPA implementation of a SecRoleEnables history primary key object.
...
/**
 *	CFSecJpaSecRoleEnablesHPKey History Primary Key for SecRoleEnables
 *		requiredSecRoleId	Required object attribute SecRoleId.
 *		requiredEnableName	Required object attribute EnableName.
 */
public class CFSecJpaSecRoleEnablesHPKey
	implements ICFSecSecRoleEnablesHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public CFSecJpaSecRoleEnablesHPKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecRoleEnablesPKey, ICFSecSecRoleEnables, ICFSecSecRoleEnablesHPKey, ICFSecSecRoleEnablesH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecRoleEnablesHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

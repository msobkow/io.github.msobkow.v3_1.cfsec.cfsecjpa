// Description: Java 25 JPA implementation of a SecClusRoleMemb history primary key object.
...
/**
 *	CFSecJpaSecClusRoleMembHPKey History Primary Key for SecClusRoleMemb
 *		requiredSecClusRoleId	Required object attribute SecClusRoleId.
 *		requiredLoginId	Required object attribute LoginId.
 */
public class CFSecJpaSecClusRoleMembHPKey
	implements ICFSecSecClusRoleMembHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public CFSecJpaSecClusRoleMembHPKey() {
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecSecClusRoleMembPKey rhs) {
			if( getRequiredSecClusRoleId() != null ) {
				if( rhs.getRequiredSecClusRoleId() != null ) {
					if( ! getRequiredSecClusRoleId().equals( rhs.getRequiredSecClusRoleId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecSecClusRoleMembH rhs) {
			if (getAuditClusterId() != null) {
				if (rhs.getAuditClusterId() != null) {
					if ( ! getAuditClusterId().equals(rhs.getAuditClusterId())) {
						return( false );
		...
		else if (obj instanceof ICFSecSecClusRoleMemb rhs) {
			if( getRequiredSecClusRoleId() != null ) {
				if( rhs.getRequiredSecClusRoleId() != null ) {
					if( ! getRequiredSecClusRoleId().equals( rhs.getRequiredSecClusRoleId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		if (obj == this) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusRoleMembPKey, ICFSecSecClusRoleMemb, CFSecSecClusRoleMembHPKey, CFSecSecClusRoleMembH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecClusRoleMembHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

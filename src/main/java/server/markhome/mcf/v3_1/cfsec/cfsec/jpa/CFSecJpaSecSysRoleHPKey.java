// Description: Java 25 JPA implementation of a SecSysRole history primary key object.
...
/**
 *	CFSecJpaSecSysRoleHPKey History Primary Key for SecSysRole
 *		requiredSecSysRoleId	Required object attribute SecSysRoleId.
 */
public class CFSecJpaSecSysRoleHPKey
	implements ICFSecSecSysRoleHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecSecSysRoleHPKey rhs) {
		...
		else if (obj instanceof ICFSecSecSysRole rhs) {
			if( getRequiredSecSysRoleId() != null ) {
				if( rhs.getRequiredSecSysRoleId() != null ) {
					if( ! getRequiredSecSysRoleId().equals( rhs.getRequiredSecSysRoleId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFSecJpaSecSysRoleHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

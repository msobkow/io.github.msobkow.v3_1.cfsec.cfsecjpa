// Description: Java 25 JPA implementation of a SecTentRoleMemb history primary key object.
...
/**
 *	CFSecJpaSecTentRoleMembHPKey History Primary Key for SecTentRoleMemb
 *		requiredSecTentRoleId	Required object attribute SecTentRoleId.
 *		requiredLoginId	Required object attribute LoginId.
 */
public class CFSecJpaSecTentRoleMembHPKey
	implements ICFSecSecTentRoleMembHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecSecTentRoleMembHPKey rhs) {
		...
		else if (obj instanceof ICFSecSecTentRoleMembPKey rhs) {
			if( getRequiredSecTentRoleId() != null ) {
				if( rhs.getRequiredSecTentRoleId() != null ) {
					if( ! getRequiredSecTentRoleId().equals( rhs.getRequiredSecTentRoleId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecSecTentRoleMembH rhs) {
			if (getAuditClusterId() != null) {
				if (rhs.getAuditClusterId() != null) {
					if ( ! getAuditClusterId().equals(rhs.getAuditClusterId())) {
						return( false );
		...
		else if (obj instanceof ICFSecSecTentRoleMemb rhs) {
			if( getRequiredSecTentRoleId() != null ) {
				if( rhs.getRequiredSecTentRoleId() != null ) {
					if( ! getRequiredSecTentRoleId().equals( rhs.getRequiredSecTentRoleId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFSecJpaSecTentRoleMembHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a Tenant history primary key object.
...
/**
 *	CFSecJpaTenantHPKey History Primary Key for Tenant
 *		requiredId	Required object attribute Id.
 */
public class CFSecJpaTenantHPKey
	implements ICFSecTenantHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecTenantHPKey rhs) {
		...
		else if (obj instanceof ICFSecTenantPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecTenant rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecProtTenantPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecPubTenantPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFSecJpaTenantHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

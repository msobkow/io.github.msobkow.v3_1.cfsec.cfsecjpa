// Description: Java 25 JPA implementation of a Cluster history primary key object.
...
/**
 *	CFSecJpaClusterHPKey History Primary Key for Cluster
 *		requiredId	Required object attribute Id.
 */
public class CFSecJpaClusterHPKey
	implements ICFSecClusterHPKey, Comparable<Object>, Serializable
{
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecClusterPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecProtClusterPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecPubClusterPKey rhs) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFSecJpaClusterHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

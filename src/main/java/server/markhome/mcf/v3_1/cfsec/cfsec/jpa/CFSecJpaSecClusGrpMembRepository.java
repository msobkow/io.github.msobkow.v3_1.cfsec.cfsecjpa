...
public interface CFSecJpaSecClusGrpMembRepository extends JpaRepository<CFSecJpaSecClusGrpMemb, CFSecJpaSecClusGrpMembPKey> {
	...
	CFSecJpaSecClusGrpMemb get(@Param("secClusGrpId") $implIJavaAtomType$ requiredSecClusGrpId,
	...
	List<CFSecJpaSecClusGrpMemb> findByClusGrpIdx(@Param("secClusGrpId") $implIJavaAtomType$ requiredSecClusGrpId);
	...
	List<CFSecJpaSecClusGrpMemb> findByLoginIdx(@Param("loginId") $implIJavaAtomType$ requiredLoginId);
	...
	@Query("select r from CFSecJpaSecClusGrpMemb r where r.requiredContainerGroup.requiredSecClusGrpId = :secClusGrpId and r.requiredParentUser.requiredLoginId = :loginId")
	CFSecJpaSecClusGrpMemb lockByIdIdx(@Param("secClusGrpId") $implIJavaAtomType$ requiredSecClusGrpId,
		@Param("loginId") $implIJavaAtomType$ requiredLoginId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFSecJpaSecClusGrpMemb r where r.requiredContainerGroup.requiredSecClusGrpId = :secClusGrpId")
	List<CFSecJpaSecClusGrpMemb> lockByClusGrpIdx(@Param("secClusGrpId") $implIJavaAtomType$ requiredSecClusGrpId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFSecJpaSecClusGrpMemb r where r.requiredParentUser.requiredLoginId = :loginId")
	List<CFSecJpaSecClusGrpMemb> lockByLoginIdx(@Param("loginId") $implIJavaAtomType$ requiredLoginId);
	...
	void deleteByClusGrpIdx(@Param("secClusGrpId") $implIJavaAtomType$ requiredSecClusGrpId);

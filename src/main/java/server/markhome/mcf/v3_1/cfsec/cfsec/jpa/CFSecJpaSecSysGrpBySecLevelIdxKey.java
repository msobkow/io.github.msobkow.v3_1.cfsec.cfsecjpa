// Description: Java 25 JPA implementation of a SecSysGrp by SecLevelIdx index key object.
	...
	implements ICFSecSecSysGrpBySecLevelIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecSysGrpBySecLevelIdxKey, ICFSecSecSysGrp$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecSysGrpBySecLevelIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

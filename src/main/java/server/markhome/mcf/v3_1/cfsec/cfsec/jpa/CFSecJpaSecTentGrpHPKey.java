// Description: Java 25 JPA implementation of a SecTentGrp history primary key object.
...
/**
 *	CFSecJpaSecTentGrpHPKey History Primary Key for SecTentGrp
 *		requiredSecTentGrpId	Required object attribute SecTentGrpId.
 */
public class CFSecJpaSecTentGrpHPKey
	implements ICFSecSecTentGrpHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public String toString() {
		String ret = "<CFSecJpaSecTentGrpHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a SecTentRoleMemb by UserIdx index key object.
	...
	implements ICFSecSecTentRoleMembByUserIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecTentRoleMembByUserIdxKey, ICFSecSecTentRoleMemb$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecTentRoleMembByUserIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a SecSysGrp history primary key object.
...
/**
 *	CFSecJpaSecSysGrpHPKey History Primary Key for SecSysGrp
 *		requiredSecSysGrpId	Required object attribute SecSysGrpId.
 */
public class CFSecJpaSecSysGrpHPKey
	implements ICFSecSecSysGrpHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecSecSysGrpHPKey rhs) {
		...
		else if (obj instanceof ICFSecSecSysGrpPKey rhs) {
			if( getRequiredSecSysGrpId() != null ) {
				if( rhs.getRequiredSecSysGrpId() != null ) {
					if( ! getRequiredSecSysGrpId().equals( rhs.getRequiredSecSysGrpId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecSecSysGrp rhs) {
			if( getRequiredSecSysGrpId() != null ) {
				if( rhs.getRequiredSecSysGrpId() != null ) {
					if( ! getRequiredSecSysGrpId().equals( rhs.getRequiredSecSysGrpId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecProtSecSysGrpPKey rhs) {
			if( getRequiredSecSysGrpId() != null ) {
				if( rhs.getRequiredSecSysGrpId() != null ) {
					if( ! getRequiredSecSysGrpId().equals( rhs.getRequiredSecSysGrpId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecPubSecSysGrpPKey rhs) {
			if( getRequiredSecSysGrpId() != null ) {
				if( rhs.getRequiredSecSysGrpId() != null ) {
					if( ! getRequiredSecSysGrpId().equals( rhs.getRequiredSecSysGrpId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		if (obj == this) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecSysGrpPKey, ICFSecSecSysGrp$emitHPKeyHistoryClassNames$" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecSysGrpHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a SecRole history primary key object.
...
/**
 *	CFSecJpaSecRoleHPKey History Primary Key for SecRole
 *		requiredSecRoleId	Required object attribute SecRoleId.
 */
public class CFSecJpaSecRoleHPKey
	implements ICFSecSecRoleHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFSecJpaSecRoleHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

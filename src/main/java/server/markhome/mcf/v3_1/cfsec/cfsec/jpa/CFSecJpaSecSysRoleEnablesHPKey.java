// Description: Java 25 JPA implementation of a SecSysRoleEnables history primary key object.
...
/**
 *	CFSecJpaSecSysRoleEnablesHPKey History Primary Key for SecSysRoleEnables
 *		requiredSecSysRoleId	Required object attribute SecSysRoleId.
 *		requiredEnableName	Required object attribute EnableName.
 */
public class CFSecJpaSecSysRoleEnablesHPKey
	implements ICFSecSecSysRoleEnablesHPKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == this) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecSysRoleEnablesPKey, ICFSecSecSysRoleEnables, CFSecSecSysRoleEnablesHPKey, CFSecSecSysRoleEnablesH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecSysRoleEnablesHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

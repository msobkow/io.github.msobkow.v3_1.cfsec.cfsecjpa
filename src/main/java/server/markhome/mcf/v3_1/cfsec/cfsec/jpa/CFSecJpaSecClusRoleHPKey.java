// Description: Java 25 JPA implementation of a SecClusRole history primary key object.
...
/**
 *	CFSecJpaSecClusRoleHPKey History Primary Key for SecClusRole
 *		requiredSecClusRoleId	Required object attribute SecClusRoleId.
 */
public class CFSecJpaSecClusRoleHPKey
	implements ICFSecSecClusRoleHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public CFSecJpaSecClusRoleHPKey() {
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecSecClusRoleHPKey rhs) {
		...
		else if (obj instanceof ICFSecSecClusRole rhs) {
			if( getRequiredSecClusRoleId() != null ) {
				if( rhs.getRequiredSecClusRoleId() != null ) {
					if( ! getRequiredSecClusRoleId().equals( rhs.getRequiredSecClusRoleId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		if (obj == this) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusRolePKey, ICFSecSecClusRole, CFSecSecClusRoleHPKey, CFSecSecClusRoleH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecClusRoleHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of SecClusRole history objects
...
@Entity
@Table(
    name = "SecClusRole_h", schema = "CFSec31",
    indexes = {
...
public class CFSecJpaSecClusRoleH
    implements ICFSecSecClusRoleH, Comparable<Object>, Serializable
{
    ...
    @EmbeddedId
    protected CFSecJpaSecClusRoleHPKey pkey;
	@AttributeOverrides({
		@AttributeOverride( name="bytes", column = @Column( name="CreatedByUserId", nullable=false, length=CFLibDbKeyHash256.HASH_LENGTH ) )
	})
	protected CFLibDbKeyHash256 createdByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$SecClusRole.S_INIT_CREATED_BY);
	...
	protected CFLibDbKeyHash256 updatedByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$SecClusRole.S_INIT_UPDATED_BY);
    ...
    public CFSecJpaSecClusRoleH() {
            ...
            pkey = new CFSecJpaSecClusRoleHPKey();
    ...
    @Override
    public ICFSecSecClusRoleHPKey getPKey() {
        return( pkey );
    }

    @Override
    public void setPKey( ICFSecSecClusRoleHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecJpaSecClusRoleHPKey) {
                this.pkey = (CFSecJpaSecClusRoleHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecJpaSecClusRoleHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecJpaSecClusRoleH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}

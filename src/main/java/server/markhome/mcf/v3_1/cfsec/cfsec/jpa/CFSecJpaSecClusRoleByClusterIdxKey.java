// Description: Java 25 JPA implementation of a SecClusRole by ClusterIdx index key object.
...
public class CFSecJpaSecClusRoleByClusterIdxKey
	implements ICFSecSecClusRoleByClusterIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredClusterId;
	public CFSecJpaSecClusRoleByClusterIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusRoleByClusterIdxKey, ICFSecSecClusRole$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecClusRoleByClusterIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a SecRoleEnables by RoleIdx index key object.
...
public class CFSecJpaSecRoleEnablesByRoleIdxKey
	implements ICFSecSecRoleEnablesByRoleIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSecRoleId;
	public CFSecJpaSecRoleEnablesByRoleIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecRoleEnablesByRoleIdxKey, ICFSecSecRoleEnables, ICFSecSecRoleEnablesH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecRoleEnablesByRoleIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

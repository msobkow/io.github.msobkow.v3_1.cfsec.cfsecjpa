...
public interface CFSecJpaSecUserPWResetRepository extends JpaRepository<CFSecJpaSecUserPWReset, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFSecJpaSecUserPWReset save(CFSecJpaSecUserPWReset obj);

// Description: Java 25 JPA implementation of SecTentRole history objects
...
/**
 *  CFSecJpaSecTentRoleH provides history objects matching the CFSecSecTentRole change history.
...
@Entity
@Table(
    name = "SecTentRole_h", schema = "CFSec31",
    indexes = {
        @Index(name = "SecTentRoleIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, SecTentRoleId", unique = true),
        @Index(name = "SecTentRoleTenantIdx_h", columnList = "TenantId", unique = false),
        @Index(name = "SecTentRoleNameIdx_h", columnList = "safe_name", unique = false),
        @Index(name = "SecTentRoleUNameIdx_h", columnList = "TenantId, safe_name", unique = false)
    }
)
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFSecPU")
public class CFSecJpaSecTentRoleH
    implements ICFSecSecTentRoleH, Comparable<Object>, Serializable
{
	@AttributeOverrides({
    ...
    @EmbeddedId
    protected CFSecJpaSecTentRoleHPKey pkey;
	@AttributeOverrides({
		@AttributeOverride( name="bytes", column = @Column( name="CreatedByUserId", nullable=false, length=CFLibDbKeyHash256.HASH_LENGTH ) )
	})
	protected CFLibDbKeyHash256 createdByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$SecTentRole.S_INIT_CREATED_BY);
	...
	protected CFLibDbKeyHash256 updatedByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$SecTentRole.S_INIT_UPDATED_BY);
    ...
    public CFSecJpaSecTentRoleH() {
            // The primary key member attributes are initialized on construction
            pkey = new CFSecJpaSecTentRoleHPKey();
    ...
    public int getClassCode() {
            return( ICFSecSecTentRole.CLASS_CODE );
    }
    ...
    @Override
    public ICFSecSecTentRoleHPKey getPKey() {
        return( pkey );
    }

    @Override
    public void setPKey( ICFSecSecTentRoleHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecJpaSecTentRoleHPKey) {
                this.pkey = (CFSecJpaSecTentRoleHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecJpaSecTentRoleHPKey");
            }
        }
    }
    ...
    public boolean equals( Object obj ) {
        ...
        else if (obj instanceof ICFSecSecTentRole) {
            ICFSecSecTentRole rhs = (ICFSecSecTentRole)obj;
		if (getPKey() != null) {
			if (rhs.getPKey() != null) {
        ...
        else if (obj instanceof ICFSecSecTentRoleHPKey) {
		ICFSecSecTentRoleHPKey rhs = (ICFSecSecTentRoleHPKey)obj;
    ...
    public String toString() {
        String ret = "<CFSecJpaSecTentRoleH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}

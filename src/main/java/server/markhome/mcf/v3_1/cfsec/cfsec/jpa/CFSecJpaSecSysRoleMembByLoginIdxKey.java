// Description: Java 25 JPA implementation of a SecSysRoleMemb by LoginIdx index key object.
...
public class CFSecJpaSecSysRoleMembByLoginIdxKey
	implements ICFSecSecSysRoleMembByLoginIdxKey, Comparable<Object>, Serializable
{
	protected String requiredLoginId;
	public CFSecJpaSecSysRoleMembByLoginIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecSysRoleMembByLoginIdxKey, ICFSecSecSysRoleMemb$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecSysRoleMembByLoginIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

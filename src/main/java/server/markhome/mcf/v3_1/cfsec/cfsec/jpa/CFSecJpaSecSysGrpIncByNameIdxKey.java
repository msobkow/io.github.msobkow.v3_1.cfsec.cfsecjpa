// Description: Java 25 JPA implementation of a SecSysGrpInc by NameIdx index key object.
	...
	implements ICFSecSecSysGrpIncByNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecSysGrpIncByNameIdxKey, ICFSecSecSysGrpInc$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecSysGrpIncByNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of SecClusGrpMemb history objects
...
/**
 *  CFSecJpaSecClusGrpMembH provides history objects matching the CFSecSecClusGrpMemb change history.
...
public class CFSecJpaSecClusGrpMembH
    implements ICFSecSecClusGrpMembH, Comparable<Object>, Serializable
{
	...
	protected CFLibDbKeyHash256 createdByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$SecClusGrpMemb.S_INIT_CREATED_BY);
	...
	protected CFLibDbKeyHash256 updatedByUserId = CFLibDbKeyHash256.fromHex(ICFSec$emitScopingMidfix$SecClusGrpMemb.S_INIT_UPDATED_BY);

	@Column(name="UpdatedAt", nullable=false)
	protected LocalDateTime updatedAt = LocalDateTime.now();

    public CFSecJpaSecClusGrpMembH() {
            // The primary key member attributes are initialized on construction
            pkey = new CFSecJpaSecClusGrpMembHPKey();
    }
    ...
    public void setPKey( ICFSecSecClusGrpMembHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecJpaSecClusGrpMembHPKey) {
                this.pkey = (CFSecJpaSecClusGrpMembHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecJpaSecClusGrpMembHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecJpaSecClusGrpMembH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}

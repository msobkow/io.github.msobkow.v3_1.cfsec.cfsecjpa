// Description: Java 25 JPA implementation of a SecUserEMConf history primary key object.
...
/**
 *	CFSecJpaSecUserEMConfHPKey History Primary Key for SecUserEMConf
 *		requiredSecUserId	Required object attribute SecUserId.
 */
public class CFSecJpaSecUserEMConfHPKey
	implements ICFSecSecUserEMConfHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecSecUserEMConfPKey rhs) {
			if( getRequiredSecUserId() != null ) {
				if( rhs.getRequiredSecUserId() != null ) {
					if( ! getRequiredSecUserId().equals( rhs.getRequiredSecUserId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFSecJpaSecUserEMConfHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

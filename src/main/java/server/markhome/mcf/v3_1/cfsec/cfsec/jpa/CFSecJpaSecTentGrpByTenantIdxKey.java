// Description: Java 25 JPA implementation of a SecTentGrp by TenantIdx index key object.
...
public class CFSecJpaSecTentGrpByTenantIdxKey
	implements ICFSecSecTentGrpByTenantIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTenantId;
	public CFSecJpaSecTentGrpByTenantIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecTentGrpByTenantIdxKey, ICFSecSecTentGrp$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecTentGrpByTenantIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

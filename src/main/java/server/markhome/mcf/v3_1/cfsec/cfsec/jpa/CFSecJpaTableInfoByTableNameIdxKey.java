// Description: Java 25 JPA implementation of a TableInfo by TableNameIdx index key object.
...
public class CFSecJpaTableInfoByTableNameIdxKey
	implements ICFSecTableInfoByTableNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecTableInfoByTableNameIdxKey, ICFSecTableInfo$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecTableInfoByTableNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a SecClusGrpMemb history primary key object.
...
/**
 *	CFSecJpaSecClusGrpMembHPKey History Primary Key for SecClusGrpMemb
 *		requiredSecClusGrpId	Required object attribute SecClusGrpId.
 *		requiredLoginId	Required object attribute LoginId.
 */
public class CFSecJpaSecClusGrpMembHPKey
	implements ICFSecSecClusGrpMembHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecSecClusGrpMembPKey rhs) {
			if( getRequiredSecClusGrpId() != null ) {
				if( rhs.getRequiredSecClusGrpId() != null ) {
					if( ! getRequiredSecClusGrpId().equals( rhs.getRequiredSecClusGrpId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecSecClusGrpMemb rhs) {
			if( getRequiredSecClusGrpId() != null ) {
				if( rhs.getRequiredSecClusGrpId() != null ) {
					if( ! getRequiredSecClusGrpId().equals( rhs.getRequiredSecClusGrpId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecProtSecClusGrpMembPKey rhs) {
			if( getRequiredSecClusGrpId() != null ) {
				if( rhs.getRequiredSecClusGrpId() != null ) {
					if( ! getRequiredSecClusGrpId().equals( rhs.getRequiredSecClusGrpId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		if (obj == this) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusGrpMembPKey, ICFSecSecClusGrpMemb, CFSecSecClusGrpMembHPKey, CFSecSecClusGrpMembH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecClusGrpMembHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

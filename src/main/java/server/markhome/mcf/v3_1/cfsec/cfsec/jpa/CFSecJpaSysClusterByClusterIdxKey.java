// Description: Java 25 JPA implementation of a SysCluster by ClusterIdx index key object.
	...
	implements ICFSecSysClusterByClusterIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSysClusterByClusterIdxKey, ICFSecSysCluster, ICFSecSysClusterH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSysClusterByClusterIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a ISOCtry by NameIdx index key object.
	...
	implements ICFSecISOCtryByNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecISOCtryByNameIdxKey, ICFSecISOCtry$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecISOCtryByNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

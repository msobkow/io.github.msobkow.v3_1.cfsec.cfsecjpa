...
public class CFSecJpaISOLangService {
	...
	public CFSecJpaISOLang create(CFSecJpaISOLang data) {
		...
		try {
			if(data.getPKey() != null && cfsec31ISOLangRepository.existsById(($implCommaIJavaOptAtomType$)data.getPKey())) {
				return( (CFSecJpaISOLang)(cfsec31ISOLangRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey())).get()));
			}
	...
	public CFSecJpaISOLang update(CFSecJpaISOLang data) {
		...
		CFSecJpaISOLang existing = cfsec31ISOLangRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey()))

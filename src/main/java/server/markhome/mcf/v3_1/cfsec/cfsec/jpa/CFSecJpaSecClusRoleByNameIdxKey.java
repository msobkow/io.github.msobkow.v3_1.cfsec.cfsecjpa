// Description: Java 25 JPA implementation of a SecClusRole by NameIdx index key object.
	...
	implements ICFSecSecClusRoleByNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusRoleByNameIdxKey, ICFSecSecClusRole$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecClusRoleByNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

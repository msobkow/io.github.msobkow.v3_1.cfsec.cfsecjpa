// Description: Java 25 JPA implementation of a SecUserPWHistory by SetStampIdx index key object.
...
public class CFSecJpaSecUserPWHistoryBySetStampIdxKey
	implements ICFSecSecUserPWHistoryBySetStampIdxKey, Comparable<Object>, Serializable
{
	protected LocalDateTime requiredPWSetStamp;
	public CFSecJpaSecUserPWHistoryBySetStampIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecUserPWHistoryBySetStampIdxKey, ICFSecSecUserPWHistory$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecUserPWHistoryBySetStampIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

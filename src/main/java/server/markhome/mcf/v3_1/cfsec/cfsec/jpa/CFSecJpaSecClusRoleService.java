...
public class CFSecJpaSecClusRoleService {
	...
	public CFSecJpaSecClusRole create(CFSecJpaSecClusRole data) {
		...
		try {
			...
			if(data.getPKey() != null && cfsec31SecClusRoleRepository.existsById((CFLibDbKeyHash256)data.getPKey())) {
	...
	public CFSecJpaSecClusRole update(CFSecJpaSecClusRole data) {
		...
		CFSecJpaSecClusRole existing = cfsec31SecClusRoleRepository.findById((CFLibDbKeyHash256)(data.getPKey()))
	...
	public CFSecJpaSecClusRole find(@Param("secClusRoleId") CFLibDbKeyHash256 requiredSecClusRoleId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfsec31TransactionManager")
	public List<CFSecJpaSecClusRole> findByClusterIdx(@Param("clusterId") CFLibDbKeyHash256 requiredClusterId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfsec31TransactionManager")
	public CFSecJpaSecClusRole findByUNameIdx(@Param("clusterId") CFLibDbKeyHash256 requiredClusterId,
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfsec31TransactionManager")
	public CFSecJpaSecClusRole lockByIdIdx(@Param("secClusRoleId") CFLibDbKeyHash256 requiredSecClusRoleId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfsec31TransactionManager")
	public List<CFSecJpaSecClusRole> lockByClusterIdx(@Param("clusterId") CFLibDbKeyHash256 requiredClusterId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfsec31TransactionManager")
	public CFSecJpaSecClusRole lockByUNameIdx(@Param("clusterId") CFLibDbKeyHash256 requiredClusterId,
		@Param("name") String requiredName) {

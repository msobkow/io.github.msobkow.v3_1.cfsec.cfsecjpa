...
public class CFSecJpaSecTentGrpMembService {
	...
	public CFSecJpaSecTentGrpMemb find(@Param("secTentGrpId") $implIJavaAtomType$ requiredSecTentGrpId,
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfsec31TransactionManager")
	public List<CFSecJpaSecTentGrpMemb> findByTentGrpIdx(@Param("secTentGrpId") $implIJavaAtomType$ requiredSecTentGrpId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfsec31TransactionManager")
	public List<CFSecJpaSecTentGrpMemb> findByUserIdx(@Param("loginId") $implIJavaAtomType$ requiredLoginId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfsec31TransactionManager")
	public CFSecJpaSecTentGrpMemb lockByIdIdx(@Param("secTentGrpId") $implIJavaAtomType$ requiredSecTentGrpId,
		@Param("loginId") $implIJavaAtomType$ requiredLoginId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfsec31TransactionManager")
	public List<CFSecJpaSecTentGrpMemb> lockByTentGrpIdx(@Param("secTentGrpId") $implIJavaAtomType$ requiredSecTentGrpId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfsec31TransactionManager")
	public List<CFSecJpaSecTentGrpMemb> lockByUserIdx(@Param("loginId") $implIJavaAtomType$ requiredLoginId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfsec31TransactionManager")
	public void deleteByTentGrpIdx(@Param("secTentGrpId") $implIJavaAtomType$ requiredSecTentGrpId) {

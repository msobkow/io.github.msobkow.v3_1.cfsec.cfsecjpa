// Description: Java 25 JPA implementation of a SecClusGrpMemb by ClusGrpIdx index key object.
...
{
	protected $implIJavaAtomType first implIJavaAtomType each implCommaIJavaAtomType empty empty )$ requiredSecClusGrpId;
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusGrpMembByClusGrpIdxKey, ICFSecSecClusGrpMemb, ICFSecSecClusGrpMembH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecClusGrpMembByClusGrpIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

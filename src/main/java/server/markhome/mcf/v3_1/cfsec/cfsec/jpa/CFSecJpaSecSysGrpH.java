// Description: Java 25 JPA implementation of SecSysGrp history objects
...
public class CFSecJpaSecSysGrpH
    implements ICFSecSecSysGrpH, Comparable<Object>, Serializable
{
    ...
    @EmbeddedId
    protected CFSecJpaSecSysGrpHPKey pkey;
	@AttributeOverrides({
    ...
    public void setPKey( ICFSecSecSysGrpHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecJpaSecSysGrpHPKey) {
                this.pkey = (CFSecJpaSecSysGrpHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecJpaSecSysGrpHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecJpaSecSysGrpH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}

// Description: Java 25 JPA implementation of a SecUserPWReset history primary key object.
...
/**
 *	CFSecJpaSecUserPWResetHPKey History Primary Key for SecUserPWReset
 *		requiredSecUserId	Required object attribute SecUserId.
 */
public class CFSecJpaSecUserPWResetHPKey
	implements ICFSecSecUserPWResetHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecSecUserPWResetPKey rhs) {
			if( getRequiredSecUserId() != null ) {
				if( rhs.getRequiredSecUserId() != null ) {
					if( ! getRequiredSecUserId().equals( rhs.getRequiredSecUserId() ) ) {
						return( false );
		...
		else if (obj instanceof ICFSecProtSecUserPWResetPKey rhs) {
			if( getRequiredSecUserId() != null ) {
				if( rhs.getRequiredSecUserId() != null ) {
					if( ! getRequiredSecUserId().equals( rhs.getRequiredSecUserId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFSecJpaSecUserPWResetHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

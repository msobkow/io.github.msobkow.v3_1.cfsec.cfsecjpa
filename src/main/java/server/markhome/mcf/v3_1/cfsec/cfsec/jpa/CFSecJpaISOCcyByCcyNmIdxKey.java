// Description: Java 25 JPA implementation of a ISOCcy by CcyNmIdx index key object.
...
public class CFSecJpaISOCcyByCcyNmIdxKey
	implements ICFSecISOCcyByCcyNmIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecISOCcyByCcyNmIdxKey, ICFSecISOCcy$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecISOCcyByCcyNmIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a TableInfo history primary key object.
...
/**
 *	CFSecJpaTableInfoHPKey History Primary Key for TableInfo
 *		requiredTableInfoId	Required object attribute TableInfoId.
 */
public class CFSecJpaTableInfoHPKey
	implements ICFSecTableInfoHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public boolean equals( Object obj ) {
		...
		else if (obj instanceof ICFSecTableInfoHPKey rhs) {
		...
		else if (obj instanceof ICFSecTableInfo rhs) {
			if( getRequiredTableInfoId() != rhs.getRequiredTableInfoId() ) {
				return( false );
			}
			return( true );
	...
	public int compareTo( Object obj ) {
		...
		if (obj == this) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecTableInfoPKey, ICFSecTableInfo, CFSecTableInfoHPKey, CFSecTableInfoH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaTableInfoHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

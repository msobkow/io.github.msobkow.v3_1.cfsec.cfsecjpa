// Description: Java 25 JPA implementation of a SecClusRole by UNameIdx index key object.
...
public class CFSecJpaSecClusRoleByUNameIdxKey
	implements ICFSecSecClusRoleByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public CFSecJpaSecClusRoleByUNameIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusRoleByUNameIdxKey, ICFSecSecClusRole$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecClusRoleByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

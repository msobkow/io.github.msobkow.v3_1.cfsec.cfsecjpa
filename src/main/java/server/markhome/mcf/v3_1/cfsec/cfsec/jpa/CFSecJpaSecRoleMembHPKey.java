// Description: Java 25 JPA implementation of a SecRoleMemb history primary key object.
...
/**
 *	CFSecJpaSecRoleMembHPKey History Primary Key for SecRoleMemb
 *		requiredSecRoleId	Required object attribute SecRoleId.
 *		requiredLoginId	Required object attribute LoginId.
 */
public class CFSecJpaSecRoleMembHPKey
	implements ICFSecSecRoleMembHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public CFSecJpaSecRoleMembHPKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecRoleMembPKey, ICFSecSecRoleMemb, ICFSecSecRoleMembHPKey, ICFSecSecRoleMembH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecRoleMembHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

...
public interface CFSecJpaISOTZoneRepository extends JpaRepository<CFSecJpaISOTZone, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFSecJpaISOTZone save(CFSecJpaISOTZone obj);

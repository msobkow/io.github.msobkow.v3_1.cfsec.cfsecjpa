...
/**
 *	Service for the CFSecISOCcy entities defined in server.markhome.mcf.v3_1.cfsec.cfsec.jpa
...
public class CFSecJpaISOCcyService {
	...
	public CFSecJpaISOCcy create(CFSecJpaISOCcy data) {
		...
		try {
			if(data.getPKey() != null && cfsec31ISOCcyRepository.existsById(($implCommaIJavaOptAtomType$)data.getPKey())) {
				return( (CFSecJpaISOCcy)(cfsec31ISOCcyRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey())).get()));
			}

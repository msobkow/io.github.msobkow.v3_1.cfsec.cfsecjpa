// Description: Java 25 JPA implementation of a SecTentRole history primary key object.
...
/**
 *	CFSecJpaSecTentRoleHPKey History Primary Key for SecTentRole
 *		requiredSecTentRoleId	Required object attribute SecTentRoleId.
 */
public class CFSecJpaSecTentRoleHPKey
	implements ICFSecSecTentRoleHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecTentRolePKey, ICFSecSecTentRole, ICFSecSecTentRoleHPKey, ICFSecSecTentRoleH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecTentRoleHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a SecClusGrp by ClusterIdx index key object.
	...
	implements ICFSecSecClusGrpByClusterIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusGrpByClusterIdxKey, ICFSecSecClusGrp$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecClusGrpByClusterIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

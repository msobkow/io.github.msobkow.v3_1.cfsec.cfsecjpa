// Description: Java 25 JPA implementation of a SecGroup by ClusterVisIdx index key object.
...
public class CFSecJpaSecGroupByClusterVisIdxKey
	implements ICFSecSecGroupByClusterVisIdxKey, Comparable<Object>, Serializable
{
	...
	public CFSecJpaSecGroupByClusterVisIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecGroupByClusterVisIdxKey, ICFSecSecGroup, ICFSecSecGroupH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecGroupByClusterVisIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

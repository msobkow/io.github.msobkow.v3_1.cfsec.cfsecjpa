// Description: Java 25 JPA implementation of a TSecGroup history primary key object.
...
/**
 *	CFSecJpaTSecGroupHPKey History Primary Key for TSecGroup
 *		requiredTSecGroupId	Required object attribute TSecGroupId.
 */
public class CFSecJpaTSecGroupHPKey
	implements ICFSecTSecGroupHPKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecTSecGroupPKey, ICFSecTSecGroup, ICFSecTSecGroupHPKey, ICFSecTSecGroupH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaTSecGroupHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a Service by TypeIdx index key object.
...
public class CFSecJpaServiceByTypeIdxKey
	implements ICFSecServiceByTypeIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredServiceTypeId;
	public CFSecJpaServiceByTypeIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecServiceByTypeIdxKey, ICFSecService, ICFSecServiceH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecServiceByTypeIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a Service history primary key object.
...
/**
 *	CFSecJpaServiceHPKey History Primary Key for Service
 *		requiredServiceId	Required object attribute ServiceId.
 */
public class CFSecJpaServiceHPKey
	implements ICFSecServiceHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecServicePKey, ICFSecService, ICFSecServiceHPKey, ICFSecServiceH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaServiceHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

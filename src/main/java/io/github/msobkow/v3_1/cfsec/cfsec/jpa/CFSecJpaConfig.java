...
@Configuration
@EntityScan(basePackages = "io.github.msobkow.v3_1.cfsec.cfsec.jpa")
@EnableTransactionManagement
@EnableJpaRepositories(
    basePackages = "io.github.msobkow.v3_1.cfsec.cfsec.jpa",
    ...
    public LocalContainerEntityManagerFactoryBean cfsec31EntityManagerFactory(
        ...
        // if (refCFSec31EntityManagerFactoryBean.get() == null) {
            ...
            try {
                ...
                emfBean.setPackagesToScan("io.github.msobkow.v3_1.cfsec.cfsec.jpa");

// Description: Java 25 JPA implementation of a TSecGrpMemb history primary key object.
...
/**
 *	CFSecJpaTSecGrpMembHPKey History Primary Key for TSecGrpMemb
 *		requiredTSecGrpMembId	Required object attribute TSecGrpMembId.
 */
public class CFSecJpaTSecGrpMembHPKey
	implements ICFSecTSecGrpMembHPKey, Comparable<Object>, Serializable
{
	...
	public CFSecJpaTSecGrpMembHPKey() {
	...
	public boolean equals( Object obj ) {
		if (obj == null) {
			...
			if( getRequiredTSecGrpMembId() != null && !getRequiredTSecGrpMembId().isNull() ) {
				if( rhs.getRequiredTSecGrpMembId() != null && !rhs.getRequiredTSecGrpMembId().isNull() ) {
				...
				if( rhs.getRequiredTSecGrpMembId() != null && !getRequiredTSecGrpMembId().isNull()) {
					return( false );
				}
			}
			return( true );
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecTSecGrpMembPKey, ICFSecTSecGrpMemb, ICFSecTSecGrpMembHPKey, ICFSecTSecGrpMembH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaTSecGrpMembHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

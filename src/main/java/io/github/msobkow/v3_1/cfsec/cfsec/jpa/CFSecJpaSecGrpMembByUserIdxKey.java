// Description: Java 25 JPA implementation of a SecGrpMemb by UserIdx index key object.
...
public class CFSecJpaSecGrpMembByUserIdxKey
	implements ICFSecSecGrpMembByUserIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSecUserId;
	public CFSecJpaSecGrpMembByUserIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecGrpMembByUserIdxKey, ICFSecSecGrpMemb, ICFSecSecGrpMembH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecGrpMembByUserIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

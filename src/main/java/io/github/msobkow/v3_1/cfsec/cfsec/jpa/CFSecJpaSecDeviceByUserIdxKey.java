// Description: Java 25 JPA implementation of a SecDevice by UserIdx index key object.
...
public class CFSecJpaSecDeviceByUserIdxKey
	implements ICFSecSecDeviceByUserIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSecUserId;
	public CFSecJpaSecDeviceByUserIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecDeviceByUserIdxKey, ICFSecSecDevice, ICFSecSecDeviceH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecDeviceByUserIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

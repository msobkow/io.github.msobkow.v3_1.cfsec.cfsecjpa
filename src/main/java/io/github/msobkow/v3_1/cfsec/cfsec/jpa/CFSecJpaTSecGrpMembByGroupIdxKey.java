// Description: Java 25 JPA implementation of a TSecGrpMemb by GroupIdx index key object.
...
public class CFSecJpaTSecGrpMembByGroupIdxKey
	implements ICFSecTSecGrpMembByGroupIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTSecGroupId;
	public CFSecJpaTSecGrpMembByGroupIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecTSecGrpMembByGroupIdxKey, ICFSecTSecGrpMemb, ICFSecTSecGrpMembH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecTSecGrpMembByGroupIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

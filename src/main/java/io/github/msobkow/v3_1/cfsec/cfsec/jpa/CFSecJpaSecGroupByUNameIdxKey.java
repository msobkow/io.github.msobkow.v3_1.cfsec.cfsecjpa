// Description: Java 25 JPA implementation of a SecGroup by UNameIdx index key object.
...
public class CFSecJpaSecGroupByUNameIdxKey
	implements ICFSecSecGroupByUNameIdxKey, Comparable<Object>, Serializable
{
	protected long requiredClusterId;
	protected String requiredName;
	public CFSecJpaSecGroupByUNameIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecGroupByUNameIdxKey, ICFSecSecGroup, ICFSecSecGroupH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecGroupByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

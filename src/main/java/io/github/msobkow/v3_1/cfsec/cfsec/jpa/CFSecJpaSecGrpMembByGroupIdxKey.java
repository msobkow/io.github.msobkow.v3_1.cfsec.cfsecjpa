// Description: Java 25 JPA implementation of a SecGrpMemb by GroupIdx index key object.
...
public class CFSecJpaSecGrpMembByGroupIdxKey
	implements ICFSecSecGrpMembByGroupIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSecGroupId;
	public CFSecJpaSecGrpMembByGroupIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecGrpMembByGroupIdxKey, ICFSecSecGrpMemb, ICFSecSecGrpMembH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecGrpMembByGroupIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a TSecGrpInc by GroupIdx index key object.
...
public class CFSecJpaTSecGrpIncByGroupIdxKey
	implements ICFSecTSecGrpIncByGroupIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTSecGroupId;
	public CFSecJpaTSecGrpIncByGroupIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecTSecGrpIncByGroupIdxKey, ICFSecTSecGrpInc, ICFSecTSecGrpIncH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecTSecGrpIncByGroupIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

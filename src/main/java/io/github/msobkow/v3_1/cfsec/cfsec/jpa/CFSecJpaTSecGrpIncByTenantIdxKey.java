// Description: Java 25 JPA implementation of a TSecGrpInc by TenantIdx index key object.
...
public class CFSecJpaTSecGrpIncByTenantIdxKey
	implements ICFSecTSecGrpIncByTenantIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTenantId;
	public CFSecJpaTSecGrpIncByTenantIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecTSecGrpIncByTenantIdxKey, ICFSecTSecGrpInc, ICFSecTSecGrpIncH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecTSecGrpIncByTenantIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

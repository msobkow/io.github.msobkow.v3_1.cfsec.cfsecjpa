// Description: Java 25 JPA implementation of a Service by HostIdx index key object.
...
public class CFSecJpaServiceByHostIdxKey
	implements ICFSecServiceByHostIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredHostNodeId;
	public CFSecJpaServiceByHostIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecServiceByHostIdxKey, ICFSecService, ICFSecServiceH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecServiceByHostIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a Service by ClusterIdx index key object.
...
public class CFSecJpaServiceByClusterIdxKey
	implements ICFSecServiceByClusterIdxKey, Comparable<Object>, Serializable
{
	protected long requiredClusterId;
	public CFSecJpaServiceByClusterIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecServiceByClusterIdxKey, ICFSecService, ICFSecServiceH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecServiceByClusterIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

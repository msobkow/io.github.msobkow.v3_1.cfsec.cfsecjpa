// Description: Java 25 JPA implementation of a TSecGroup by TenantIdx index key object.
...
public class CFSecJpaTSecGroupByTenantIdxKey
	implements ICFSecTSecGroupByTenantIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTenantId;
	public CFSecJpaTSecGroupByTenantIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecTSecGroupByTenantIdxKey, ICFSecTSecGroup, ICFSecTSecGroupH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecTSecGroupByTenantIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a TSecGrpInc by IncludeIdx index key object.
...
public class CFSecJpaTSecGrpIncByIncludeIdxKey
	implements ICFSecTSecGrpIncByIncludeIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredIncludeGroupId;
	public CFSecJpaTSecGrpIncByIncludeIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecTSecGrpIncByIncludeIdxKey, ICFSecTSecGrpInc, ICFSecTSecGrpIncH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecTSecGrpIncByIncludeIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a ISOCtryLang history primary key object.
...
/**
 *	CFSecJpaISOCtryLangHPKey History Primary Key for ISOCtryLang
 *		requiredISOCtryId	Required object attribute ISOCtryId.
 *		requiredISOLangId	Required object attribute ISOLangId.
 */
public class CFSecJpaISOCtryLangHPKey
	implements ICFSecISOCtryLangHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecISOCtryLangPKey, ICFSecISOCtryLang, ICFSecISOCtryLangHPKey, ICFSecISOCtryLangH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaISOCtryLangHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a ISOLang history primary key object.
...
/**
 *	CFSecJpaISOLangHPKey History Primary Key for ISOLang
 *		requiredISOLangId	Required object attribute ISOLangId.
 */
public class CFSecJpaISOLangHPKey
	implements ICFSecISOLangHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecISOLangPKey, ICFSecISOLang, ICFSecISOLangHPKey, ICFSecISOLangH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaISOLangHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

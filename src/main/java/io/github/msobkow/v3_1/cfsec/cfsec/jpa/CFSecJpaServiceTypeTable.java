...
// Description: Java 25 DbIO implementation for ServiceType.
...
public class CFSecJpaServiceTypeTable implements ICFSecServiceTypeTable
{
	...
	{
		if (rec == null) {
			throw new CFLibNullArgumentException(getClass(), "createServiceType", 1, "rec");
		}
		else if (rec instanceof CFSecJpaServiceType) {
			CFSecJpaServiceType jparec = (CFSecJpaServiceType)rec;
			CFSecJpaServiceType created = servicetypeService.create(jparec);
			return( created );
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "createServiceType", "rec", rec, "CFSecJpaServiceType");
		}
	}
	...
	{
		if (rec == null) {
			throw new CFLibNullArgumentException(getClass(), "updateServiceType", 1, "rec");
		}
		else if (rec instanceof CFSecJpaServiceType) {
			CFSecJpaServiceType jparec = (CFSecJpaServiceType)rec;
			CFSecJpaServiceType updated = servicetypeService.update(jparec);
			return( updated );
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "updateServiceType", "rec", rec, "CFSecJpaServiceType");
		}
	}
		...
		ICFSecServiceType rec )
	{
		...
		if (rec instanceof CFSecJpaServiceType) {
			CFSecJpaServiceType jparec = (CFSecJpaServiceType)rec;
			servicetypeService.deleteByIdIdx(jparec.getPKey());
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "deleteServiceType", "rec", rec, "CFSecJpaServiceType");
		}

		throw new CFLibNotImplementedYetException(getClass(), "deleteServiceType");
	}
	...
	{
		servicetypeService.deleteByIdIdx(argKey);
	}
	...
	{
		servicetypeService.deleteByUDescrIdx(argDescription);
	}
	...
	{
		servicetypeService.deleteByUDescrIdx(argKey.getRequiredDescription());
	}
	...
	{
		return( servicetypeService.find(PKey) );
	}
	...
	public ICFSecServiceType lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( servicetypeService.lockByIdIdx(PKey) );
	}
	...
	public ICFSecServiceType[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFSecJpaServiceType> results = servicetypeService.findAll();
	...
	{
		return( servicetypeService.find(argServiceTypeId) );
	}
	...
	public ICFSecServiceType readDerivedByUDescrIdx( ICFSecAuthorization Authorization,
		String argDescription )
	{
		return( servicetypeService.findByUDescrIdx(argDescription) );
	}

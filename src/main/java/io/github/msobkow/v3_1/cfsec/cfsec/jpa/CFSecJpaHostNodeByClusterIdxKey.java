// Description: Java 25 JPA implementation of a HostNode by ClusterIdx index key object.
...
public class CFSecJpaHostNodeByClusterIdxKey
	implements ICFSecHostNodeByClusterIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredClusterId;
	public CFSecJpaHostNodeByClusterIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecHostNodeByClusterIdxKey, ICFSecHostNode, ICFSecHostNodeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecHostNodeByClusterIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a SecGroup history primary key object.
...
/**
 *	CFSecJpaSecGroupHPKey History Primary Key for SecGroup
 *		requiredSecGroupId	Required object attribute SecGroupId.
 */
public class CFSecJpaSecGroupHPKey
	implements ICFSecSecGroupHPKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecGroupPKey, ICFSecSecGroup, ICFSecSecGroupHPKey, ICFSecSecGroupH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecGroupHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

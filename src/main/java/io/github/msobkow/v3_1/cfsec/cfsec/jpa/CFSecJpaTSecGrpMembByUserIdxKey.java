// Description: Java 25 JPA implementation of a TSecGrpMemb by UserIdx index key object.
...
public class CFSecJpaTSecGrpMembByUserIdxKey
	implements ICFSecTSecGrpMembByUserIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSecUserId;
	public CFSecJpaTSecGrpMembByUserIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecTSecGrpMembByUserIdxKey, ICFSecTSecGrpMemb, ICFSecTSecGrpMembH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecTSecGrpMembByUserIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

// Description: Java 25 JPA implementation of a SecGroup by ClusterIdx index key object.
...
public class CFSecJpaSecGroupByClusterIdxKey
	implements ICFSecSecGroupByClusterIdxKey, Comparable<Object>, Serializable
{
	protected long requiredClusterId;
	public CFSecJpaSecGroupByClusterIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecGroupByClusterIdxKey, ICFSecSecGroup, ICFSecSecGroupH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecGroupByClusterIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

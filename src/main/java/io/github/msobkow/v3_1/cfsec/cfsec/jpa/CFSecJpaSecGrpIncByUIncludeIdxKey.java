// Description: Java 25 JPA implementation of a SecGrpInc by UIncludeIdx index key object.
...
public class CFSecJpaSecGrpIncByUIncludeIdxKey
	implements ICFSecSecGrpIncByUIncludeIdxKey, Comparable<Object>, Serializable
{
	protected long requiredClusterId;
	protected CFLibDbKeyHash256 requiredSecGroupId;
	protected CFLibDbKeyHash256 requiredIncludeGroupId;
	public CFSecJpaSecGrpIncByUIncludeIdxKey() {
		requiredClusterId = ICFSecSecGrpInc.CLUSTERID_INIT_VALUE;
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecGrpIncByUIncludeIdxKey, ICFSecSecGrpInc, ICFSecSecGrpIncH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecGrpIncByUIncludeIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

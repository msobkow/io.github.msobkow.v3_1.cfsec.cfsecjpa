// Description: Java 25 JPA implementation of a ServiceType history primary key object.
...
/**
 *	CFSecJpaServiceTypeHPKey History Primary Key for ServiceType
 *		requiredServiceTypeId	Required object attribute ServiceTypeId.
 */
public class CFSecJpaServiceTypeHPKey
	implements ICFSecServiceTypeHPKey, Comparable<Object>, Serializable
{
	@AttributeOverrides({
	...
	public CFSecJpaServiceTypeHPKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecServiceTypePKey, ICFSecServiceType, ICFSecServiceTypeHPKey, ICFSecServiceTypeH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaServiceTypeHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

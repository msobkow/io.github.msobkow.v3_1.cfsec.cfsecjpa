// Description: Java 25 JPA implementation of a SecGrpInc history primary key object.
...
/**
 *	CFSecJpaSecGrpIncHPKey History Primary Key for SecGrpInc
 *		requiredSecGrpIncId	Required object attribute SecGrpIncId.
 */
public class CFSecJpaSecGrpIncHPKey
	implements ICFSecSecGrpIncHPKey, Comparable<Object>, Serializable
{
	...
	public boolean equals( Object obj ) {
		if (obj == null) {
			...
			if( getRequiredSecGrpIncId() != null && !getRequiredSecGrpIncId().isNull() ) {
				if( rhs.getRequiredSecGrpIncId() != null && !rhs.getRequiredSecGrpIncId().isNull() ) {
				...
				if( rhs.getRequiredSecGrpIncId() != null && !getRequiredSecGrpIncId().isNull()) {
					return( false );
				}
			}
			return( true );
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecGrpIncPKey, ICFSecSecGrpInc, ICFSecSecGrpIncHPKey, ICFSecSecGrpIncH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecGrpIncHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

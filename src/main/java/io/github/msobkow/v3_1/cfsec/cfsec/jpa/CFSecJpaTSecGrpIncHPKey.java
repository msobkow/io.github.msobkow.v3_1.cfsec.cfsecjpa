// Description: Java 25 JPA implementation of a TSecGrpInc history primary key object.
...
/**
 *	CFSecJpaTSecGrpIncHPKey History Primary Key for TSecGrpInc
 *		requiredTSecGrpIncId	Required object attribute TSecGrpIncId.
 */
public class CFSecJpaTSecGrpIncHPKey
	implements ICFSecTSecGrpIncHPKey, Comparable<Object>, Serializable
{
	...
	public CFSecJpaTSecGrpIncHPKey() {
	...
	public boolean equals( Object obj ) {
		if (obj == null) {
			...
			if( getRequiredTSecGrpIncId() != null && !getRequiredTSecGrpIncId().isNull() ) {
				if( rhs.getRequiredTSecGrpIncId() != null && !rhs.getRequiredTSecGrpIncId().isNull() ) {
				...
				if( rhs.getRequiredTSecGrpIncId() != null && !getRequiredTSecGrpIncId().isNull()) {
					return( false );
				}
			}
			return( true );
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecTSecGrpIncPKey, ICFSecTSecGrpInc, ICFSecTSecGrpIncHPKey, ICFSecTSecGrpIncH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaTSecGrpIncHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

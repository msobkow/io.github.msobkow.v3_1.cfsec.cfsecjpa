// Description: Java 25 JPA implementation of a SecGrpInc by GroupIdx index key object.
...
public class CFSecJpaSecGrpIncByGroupIdxKey
	implements ICFSecSecGrpIncByGroupIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSecGroupId;
	public CFSecJpaSecGrpIncByGroupIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecGrpIncByGroupIdxKey, ICFSecSecGrpInc, ICFSecSecGrpIncH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecGrpIncByGroupIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

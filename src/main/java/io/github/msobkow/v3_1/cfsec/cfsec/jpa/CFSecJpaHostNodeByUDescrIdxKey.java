// Description: Java 25 JPA implementation of a HostNode by UDescrIdx index key object.
...
public class CFSecJpaHostNodeByUDescrIdxKey
	implements ICFSecHostNodeByUDescrIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredClusterId;
	protected String requiredDescription;
	public CFSecJpaHostNodeByUDescrIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecHostNodeByUDescrIdxKey, ICFSecHostNode, ICFSecHostNodeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecHostNodeByUDescrIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

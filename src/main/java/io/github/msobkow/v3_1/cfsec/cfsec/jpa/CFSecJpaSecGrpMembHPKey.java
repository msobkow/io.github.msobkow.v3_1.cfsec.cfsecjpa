// Description: Java 25 JPA implementation of a SecGrpMemb history primary key object.
...
/**
 *	CFSecJpaSecGrpMembHPKey History Primary Key for SecGrpMemb
 *		requiredSecGrpMembId	Required object attribute SecGrpMembId.
 */
public class CFSecJpaSecGrpMembHPKey
	implements ICFSecSecGrpMembHPKey, Comparable<Object>, Serializable
{
	...
	public CFSecJpaSecGrpMembHPKey() {
	...
	public boolean equals( Object obj ) {
		if (obj == null) {
			...
			if( getRequiredSecGrpMembId() != null && !getRequiredSecGrpMembId().isNull() ) {
				if( rhs.getRequiredSecGrpMembId() != null && !rhs.getRequiredSecGrpMembId().isNull() ) {
				...
				if( rhs.getRequiredSecGrpMembId() != null && !getRequiredSecGrpMembId().isNull()) {
					return( false );
				}
			}
			return( true );
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"ICFSecSecGrpMembPKey, ICFSecSecGrpMemb, ICFSecSecGrpMembHPKey, ICFSecSecGrpMembH" );
		}
	}
	...
	public String toString() {
		String ret = "<CFSecJpaSecGrpMembHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
